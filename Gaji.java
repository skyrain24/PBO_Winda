...
public class Gaji extends Pegawai{
    ...
    public void mailCheck(){ /*merupakan polymorphism karena method ini juga ada di kelas pegawai dan isinya berbeda 
        dengan method yang ada pada kelas induknya yaitu kelas pegawai*/
